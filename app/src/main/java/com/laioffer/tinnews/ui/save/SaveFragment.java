    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getAllSavedArticles()
                .observe(
                        ...
                        savedNews -> {
                            if(savedNews != null){
                                Log.d("SaveFragment", savedNews.toString());
                                savedNewsAdapter.setArticles(savedNews);
                            }
                        }
                );
        ...
        savedNewsAdapter.setItemCallback(new SavedNewsAdapter.ItemCallback() {
            @Override
            public void onOpenDetail(News news) {
                Log.d("onOpenDetails", news.toString());
            ...
            @Override
            public void onRemoveFavorite(News news) {
                viewModel.deleteSavedArticle(news);
            }
        });
    }
}